...
INSERT INTO oc_pizza.order
    (client_id, is_paid, order_notes, order_date, is_online, delivery_notes, order_status, delivery_mode, payment_type, pizza_maker_id, delivery_man_id)
VALUES
    (1, true, 'Pourriez-vous enlever le bleu svp ?', '2022-02-11', true, 'Appelez-moi quand vous serez arrivé svp, merci !', 'finished', 'delivery', 'online_credit_card', 1, 2),
    (2, false, null, '2022-02-20', true, 'Appelez-moi svp, merci !', 'preparing', 'delivery', null, 5, null),
    (3, false, null, '2022-02-21', true, 'La sonnette est cassée, appelez-moi svp', 'delivering', 'delivery', null, 5, 6),
    (4, true, null, '2022-02-21', true, null, 'finished', 'pickup', 'cash', 9, null),
    (5, true, null, '2022-02-21', false, null, 'preparing', 'pickup', 'cash', 13, null),
    (6, true, 'Je voudrais enlever l\'Aneth svp', '2022-02-22', false, 'Appelez-moi svp, merci !', 'finished', 'delivery', 'offline_credit_card', 13, 14),
    (7, false, null, '2022-02-22', false, null, 'waiting', 'pickup', null, null, null),
    (8, true, null, '2022-02-22', true, null, 'delivering', 'delivery', 'online_credit_card', 17, 18),
    (9, false, null, '2022-02-24', false, null, 'waiting', 'delivery', null, null, null),
    (10, false, null, '2022-02-26', true, null, 'delivering', 'delivery', null, 9, 10);


INSERT INTO oc_pizza.article_quantity
    (order_id, client_id, article, quantity)
VALUES
    (1, 1, '4 Fromages', 2),
    (2, 2, '4 Fromages', 1),
    (2, 2, 'Napolitaine', 1),
